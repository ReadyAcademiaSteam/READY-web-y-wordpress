    ...
    <div class="panel-body">
      <form id="form_ins" name="form_ins" method="post" role="form" class="form-horizontal form-groups-standar validate">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9"><input id="titulo" name="titulo" data-validate="required" type="text" class="form-control" placeholder="t&iacute;tulo" autofocus></div>
		    </div>
...
<div id="modal_exito" class="modal fade" data-backdrop="static">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
        <h4><img src="imagenes/ico_ok.png" style="margin:0 20px 0 0" />Bolet&iacute;n insertado correctamente</h4>
      </div>
