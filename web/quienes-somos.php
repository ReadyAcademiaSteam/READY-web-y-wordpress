...
<section class="box-fancy section-fullwidth text-light p-b-0">
    <div class="row">
        ...
        <span data-animation="fadeIn">The most happiest time of the day!. Morbi sagittis, sem quis lacinia faucibus, orci ipsum gravida tortor, vel interdum mi sapien ut justo. Nulla varius consequat magna, id molestie ipsum volutpat quis. A true story, that never been told!. </span>
        </div>

        <div style="background-color:#5994aa" class="col-lg-4">
        <h1 class="text-lg text-uppercase">02.</h1>
        <h3>Tecnología</h3>
        <span data-animation="fadeIn" style="animation-delay: 0.25s">The most happiest time of the day!. Morbi sagittis, sem quis lacinia faucibus, orci ipsum gravida tortor, vel interdum mi sapien ut justo. Nulla varius consequat magna, id molestie ipsum volutpat quis. A true story, that never been told!. </span>
        </div>

        <div style="background-color:#ffdf66" class="col-lg-4">
        <h1 class="text-lg text-uppercase">03.</h1>
        <h3>Idiomas</h3>
        <span data-animation="fadeIn" style="animation-delay: 0.5s">The most happiest time of the day!. Morbi sagittis, sem quis lacinia faucibus, orci ipsum gravida tortor, vel interdum mi sapien ut justo. Nulla varius consequat magna, id molestie ipsum volutpat quis. A true story, that never been told!. </span>
        </div>
    </div>
</section>
