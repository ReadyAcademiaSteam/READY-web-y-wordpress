...
if(isset($_GET["ref"])&&($_GET["ref"]!='')){
	$ref = $_GET["ref"];
	$sql = "SELECT * FROM contenidos WHERE ref_menu=4 AND ref=".$ref;
					...
					<div class="post-item">
						<div class="post-item-wrap">
							...
							<? if($row["foto"]){ ?>
								<div class="post-image" data-lightbox="gallery">
									<a href="imagenes/contenidos/<? echo $row["foto"]; ?>" class="image-hover-zoom" data-lightbox="gallery-item">
										<img src="imagenes/contenidos/4/<? echo $row["foto"]; ?>" alt="<? echo $row_info["titulo"]; ?>">
									</a>
								</div>
							<? } ?>
							...
							<div class="post-item-description">
								...
								<div class="post-meta">
									<span class="post-meta-date"><i class="fa fa-calendar-o"></i><? echo distancia_fechas($row["fecha_ini"],$row["fecha_fin"]); ?> de <? echo substr($row["fecha_fin"], 0,4); ?></span>
