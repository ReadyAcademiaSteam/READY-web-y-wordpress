...
function get_function_class_array_from_plugin_path($plugin){
  //returns array ['function'=>[''],'class'=>['']]
  if(!empty(get_all_function_class_array_plugin_path()) && isset(get_all_function_class_array_plugin_path()[$plugin])){
    return get_all_function_class_array_plugin_path()[$plugin];
  }
  return array();
}
