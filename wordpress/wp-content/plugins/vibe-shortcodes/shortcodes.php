...
/*-----------------------------------------------------------------------------------*/
    ...
    function vibe_number_counter( $atts, $content = null ) {
        ...
        wp_enqueue_script( 'counter-js', VIBE_PLUGIN_URL . '/vibe-shortcodes/js/scroller-counter.js',array('jquery'),'1.2',true);
...
/*-----------------------------------------------------------------------------------*/
    ...
    function vibe_iframe( $atts, $content = null ) {
        ...
        'endpoint'=>'',
        'popup'=>0,
        'button_label'=>_x('Open','open label in iframe shortcode','vibe-shortcodes')
        ), $atts));
        ...
        if(!empty($package_type) && $package_type != 'default'){
            ...
            $scorm_script = plugin_dir_path( __FILE__).'js/scorm.js';
...
/*-----------------------------------------------------------------------------------*/
    ...
    function wplms_login_widget($atts,$content=null){
        ...
        <?php
            ...
            ?>  
           <a href="#login" rel="nofollow" class=" vbplogin"><span><?php _e('LOGIN','vibe-shortcodes'); ?></span></a>          
                <?php
        endif;
